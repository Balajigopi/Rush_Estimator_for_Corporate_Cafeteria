...
organization = "crdv1x"
device_type = "NO-queue"
device_id = "33333"
auth_method = "token"
auth_token = "123456789"

# Function to publish data to IBM Watson IoT platform
def publish_data(up_count, down_count):
    try:
        ...
        # Publish the data
        device_client.publishEvent("status", "json", data)
...
while(cap.isOpened()):
    ...
    #Writing the log
    ##    log.write("Input line: " + str(up_limit) + " Linea de salida: " + str(down_limit) + "\n")
    ##    log.write("People who crossed the entry line: " + str(cnt_up) + "\n")
    ##    log.write("People who crossed the start line: " + str(cnt_down) + "\n")
    ##    log.write(" People ID: "+ str(id_person) + "\n")
    ##    log.write("Total people : "+ str(id_person) + "\n")
    ##    log.write("Total arrives : "+ str(total_up) + "\n")
    ##    log.write("full down : "+ str(total_down) + "\n")
    ##    log.write("Total : "+ str(total_people) + "\n")
    ##    log.write("Total ID : "+ str(list_id) + "\n")
